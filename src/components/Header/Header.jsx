import { AppBar, Toolbar, Stack, Typography, Box, Badge } from "@mui/material";
...
export const Header = () => {
  return (
    <AppBar position="static">
      <Toolbar className={s.containerOfContainer}>
        ...
        <Stack direction="row" spacing={2} className={s.containerNav}>
          <NavLink
            to="/"
            style={{ textDecoration: "none", color: "inherit" }}
            className={s.linkPages}
          >
            <Typography className={s.textPages} variant="h6">
              Main Page
            </Typography>
          </NavLink>
